...
class User(db.Model):
    ...
    from_ldap = db.Column(db.Boolean, default=False)
...
class Setting(db.Model):
    ...
    enable_add_user = db.Column(db.Boolean, default=True)

    ldap_enabled = db.Column(db.Boolean, default=False)
    ldap_server = db.Column(db.String(255))
    ldap_base = db.Column(db.String(255))
    ldap_admin_filter = db.Column(db.String(255))
